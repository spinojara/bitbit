...
static const uint32_t piece_to_index[2][13] = {
	{
         0, PS_B_PAWN,
         PS_B_KNIGHT, PS_B_BISHOP,
         PS_B_ROOK, PS_B_QUEEN,
         PS_KING, PS_W_PAWN,
         PS_W_KNIGHT, PS_W_BISHOP,
         PS_W_ROOK, PS_W_QUEEN,
         PS_KING, },
	{
         0, PS_W_PAWN,
         PS_W_KNIGHT, PS_W_BISHOP,
...
static inline uint16_t make_index(int turn, int square, int piece, int king_square) {
	return orient(turn, square, king_square) + piece_to_index[turn][piece]
	     + PS_END * king_bucket[orient_horizontal(turn, king_square)];
}
