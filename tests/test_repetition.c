...
static int repetition_helper(const char *str, int upcoming_rep, int repetition_once, int repetition_twice) {
	struct position pos;
	struct history h;
...
static void test_repetition_1(void) {
	repetition_helper("startpos moves e2e4 c7c5 g1f3 b8c6 f1b5 g7g6 e1g1 f8g7 b1c3 e7e5 b5c4 g8e7", 0, 0, 0);
}

static void test_repetition_2(void) { repetition_helper("startpos moves e2e4 e7e5 e1e2 e8e7 e2e1", 0, 0, 0); }

static void test_repetition_3(void) {
...
static void test_repetition_6(void) {
...
static void test_repetition_7(void) {
