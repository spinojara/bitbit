...
int main(void) {
	...
	pSuite = CU_add_suite("Movepicker", NULL, NULL);
	CU_add_test(pSuite, "rnbqkbnr/pppppppp/8/8/8/8/PPPPPPPP/RNBQKBNR w KQkq - 0 1", test_movepicker_1);
	CU_add_test(pSuite, "r3k2r/p1ppqpb1/bn2pnp1/3PN3/1p2P3/2N2Q1p/PPPBBPPP/R3K2R w KQkq -", test_movepicker_2);
	CU_add_test(pSuite, "8/2p5/3p4/KP5r/1R3p1k/8/4P1P1/8 w - - 0 1", test_movepicker_3);
	CU_add_test(pSuite, "r3k2r/Pppp1ppp/1b3nbN/nP6/BBP1P3/q4N2/Pp1P2PP/R2Q1RK1 w kq - 0 1", test_movepicker_4);
	CU_add_test(pSuite, "rnbq1k1r/pp1Pbppp/2p5/8/2B5/8/PPP1NnPP/RNBQK2R w KQ - 1 8", test_movepicker_5);
	CU_add_test(pSuite, "r4rk1/1pp1qppp/p1np1n2/2b1p1B1/2B1P1b1/P1NP1N2/1PP1QPPP/R4RK1 w - - 0 10", test_movepicker_6);
