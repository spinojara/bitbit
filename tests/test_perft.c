...
void compare_keys(const struct position *pos, uint64_t zobrist_key, uint64_t endgame_key,
...
void test_perft_3(void) { CU_ASSERT_EQUAL(perft_helper("8/2p5/3p4/KP5r/1R3p1k/8/4P1P1/8 w - - 0 1", 7), 178633661); }
